      ...
      <main className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="font-serif text-5xl md:text-7xl font-normal text-deep-black tracking-tight leading-[0.9] italic mb-8 animate-fade-in-up">
              Acerca de
            </h1>
            <p className="font-sans text-lg text-deep-black/70 leading-relaxed font-light max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="text-center mt-16 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <Link 
              href="/"
              className="font-sans text-sm tracking-[0.15em] uppercase text-deep-black/80 hover:text-deep-black hover:underline focus:text-deep-black focus:underline focus:outline-none transition-all duration-300 font-light"
            >
              ← Volver al inicio
            </Link>
          </div>
