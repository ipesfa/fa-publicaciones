        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="flex-1">
            ...
            <p className="font-neue-machina text-sm text-deep-black/70 leading-relaxed max-w-md">
              Sello institucional que reúne nuestros dos proyectos culturales. Portal de publicaciones académicas del Instituto Provincial de Enseñanza Superior Florentino Ameghino.
            </p>
          </div>
