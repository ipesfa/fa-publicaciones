            ...
            <div className="relative p-12 md:p-16 h-full flex flex-col justify-between min-h-[400px]">
              ...
              <div className="mb-8">
                <div className="w-16 h-16 mb-6 flex items-center justify-center bg-sage-dark/10 group-hover:bg-sage-dark/15 transition-all duration-500">
                  <div className="text-2xl font-bold text-deep-black group-hover:scale-110 transition-transform duration-500">
                    FA
                  </div>
                </div>
                <h2 className="font-serif text-4xl md:text-5xl font-normal text-deep-black mb-4 tracking-tight leading-tight group-hover:text-deep-black transition-colors duration-500">
                  Revista
                </h2>
                <p className="font-serif text-base text-deep-black/70 leading-relaxed font-light max-w-sm group-hover:text-deep-black transition-colors duration-500">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <span className="font-sans text-sm tracking-[0.15em] uppercase font-light mr-4 group-hover/btn:mr-6 transition-all duration-300">
                    Explorar
                  </span>
